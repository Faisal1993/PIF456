...
if ($res) { 
  if (mysql_num_rows($res)) { ?> 
	<h1 align=center class="heading">VIEW DATA</h1> 
...
<a href="<?php echo $root;?>&amp;act=add"><input type="submit" value="Tambah Data" /></a>
</div> 
...
<td align="center"> 
<a href="<?php echo $root;?>&amp;act=edit&amp;id=<?php echo $id;?>"><input type="submit" value="Edit" /></a>
<a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="<?php echo $root;?>&amp;act=del&amp;id=<?php echo $id;?>"><input type="submit" value="Hapus" /></a>
</td> 
</tr> 
<?php 
$i++; 
